...
for i in range(7, MAX_SIZE + 1):
    prog = f"/home/w732t351/repos/dnf-sat/src/converter_new_par_opt /home/w732t351/repos/dnf-sat/test_suite/test_ConstConj_{i}.cnf > /dev/null"
